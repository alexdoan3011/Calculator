...
var jsCurry = function () {
    ...
    return Function.prototype.bind || (Function.prototype.bind = function (e) {
        var r = this, n = t.call(arguments, 1);
        return function () {
        ...
        var a = r.length;
        return function () {
            for (var i = t.call(arguments, 0), s = 0; a > s; s++) r[s] !== e._ ? i.splice(s, 0, r[s]) : i.length == s && i.push(void 0);
        ...
        for (var r = t.length, n = 0; r > n; n++) if (e(t[n], n, t)) return n;
        return -1
    }, e.findLastIndex = function (e, t) {
        for (var r = t.length; --r >= 0;) if (e(t[r], r, t)) return r;
        return -1
    }, e.find = function (t, r) {
        ...
        for (var r = t.length, n = 0; r > n; n++) if (!e(t[n], n, t)) return !1;
        return !0
    }, e.any = function (e, t) {
        for (var r = t.length, n = !1, a = 0; r > a; a++) if (n = e(t[a], a, t)) return n;
        return n
    }, e.iter = function (r, n) {
        if (2 == arguments.length) {
        ...
        if ("object" == typeof t) {
            var r = Object.keys(t), n = e.map(e.o(e.test, e(t)), r);
            return function (t) {
        ...
        e.err(err_test_)
    }, e.translations_ = {}, e.s = function (t) {
        return e.translations_[t] || t
    }, e
}(), F;
void 0 === F && (F = jsCurry), "object" == typeof module && (module.exports = jsCurry);
var jqMath = function () {
    function e(t, r, n) {
        return "number" == typeof t && (t = String(t)), "string" == typeof t || Array.isArray(t) ? e.sToMathE(t, r, n) : 1 == t.nodeType && "math" == t.tagName.toLowerCase() ? e.eToMathE(t) : void O.err(err_M_)
    }

    function t(t, r, n) {
        return null == r || ("string" == typeof r ? t.appendChild(t.ownerDocument.createTextNode(r)) : r.nodeType ? t.appendChild(r) : (r.constructor != Array && (r = O.slice(r)), O.iter(function (e) {
            t.appendChild(e)
        }, r))), e.setAttrs(t, n)
    }
    ...
    function r(r) {
        ...
        if (e.MathML && !E) return r;
        var a = r.tagName.toLowerCase(), i = r.ownerDocument;
        if ("mi" == a) !r.getAttribute("mathvariant") && r.firstChild && 3 == r.firstChild.nodeType && r.setAttribute("mathvariant", 1 == r.firstChild.data.length ? "italic" : "normal"); else if ("mo" == a) {
            if (1 == r.childNodes.length && 3 == r.firstChild.nodeType) {
                var s = r.firstChild.data;
                /^[\u2061-\u2064]$/.test(s) && e.addClass(r, "ma-non-marking")
            }
        } else if ("mspace" == a) e.webkitVersion && e.MathML && (r.style.display = "inline-block", r.style.minWidth = r.getAttribute("width") || "0px"); else if ("menclose" == a) e.webkitVersion && e.MathML && e.addClass(r, "fm-menclose"); else if ("mmultiscripts" == a && e.webkitVersion) {
            var o = O.slice(r.childNodes);
            if (0 == o.length) throw"Wrong number of <mmultiscripts> arguments: 0";
            for (var u = [o[0]], l = 1; l < o.length; l++) if ("mprescripts" != o[l].tagName) {
                if (l + 1 == o.length) throw"Missing argument in <mmultiscripts>";
                var m = [u[0], o[l], o[l + 1]];
                l++, u[0] = n("msubsup"), O.iter(function (e) {
                    u[0].appendChild(e)
                }, m)
            } else u.unshift(n("none"));
            var f = r;
            r = t(n("mrow"), u, r.attributes), f.parentNode && f.parentNode.replaceChild(r, f)
        }
        var c = r.getAttribute("mathcolor"), p = r.getAttribute("href");
        if (c && r.style && (r.style.color = c), p && (!e.MathML || e.webkitVersion)) {
            var d = i.createElement("A"), h = r.parentNode, g = r.nextSibling;
    ...
    function a(t, r, n, a) {
        if ("mo" == n.nodeName.toLowerCase() && 1 == n.childNodes.length) {
            var i = n.firstChild, s = i.data;
            if (3 == i.nodeType && (t > .9 || r > .9) && (e.prefix_[s] < 25 || e.postfix_[s] < 25 || -1 != "|‖√".indexOf(s) || a)) {
                var o = (t + r) / 1.2, u = "√" == s, l = (u ? .26 : .35) + ((u ? .15 : .25) - r) / o;
                n.style.fontSize = o.toFixed(3) + "em", n.style.verticalAlign = l.toFixed(3) + "em", n.fmUp = t, n.fmDn = r, n.style.display = "inline-block", n.style.transform = n.style.msTransform = n.style.MozTransform = n.style.WebkitTransform = "scaleX(0.5)"
            }
        }
    }
    ...
    function i(e, t, r) {
        ...
        return n[0].fmUp = e, n[0].fmDn = t, n[0].style.verticalAlign = (.5 * (e - t)).toFixed(3) + "em", n
    }
    ...
    function m(t) {
        ...
        for (i.lastIndex = r.lastIndex; ;) {
            if (n = i.exec(Q), !n) throw"Missing closing " + a;
            if (n[2]) break;
            s += n[1] || n[0]
        }
    ...
    function p() {
        ...
        var t = m("html"), r = D("<div/>", H || document).css("display", "inline-block").html(t)[0];
    ...
    function h() {
        ...
        var n = j(0, t);
        return t = n[1], !t || "}" == t[1] && !t[0] || O.err(err_braceScan_), [n[0] || u(), null]
    }

    function g(t, r) {
        t || (t = l("attribute name"));
        var n = m(t + " attribute"), a = f(t);
        return (!r || e.MathML) && a[0].setAttribute(t, n), a
    }

    function v() {
        var t = "CSS class name(s)", r = m(t), n = f(t);
        return e.addClass(n[0], r), n
    }

    function y(t) {
        var r = t || m("mathvariant"), n = f(r), a = n[0];
        if (!O.elem(e.mtagName(a), ["mi", "mn", "mo", "mtext", "mspace", "ms"])) throw"Can only apply a mathvariant to a MathML token (atomic) element, at position " + e.re_.lastIndex;
    ...
    function M(e) {
        e || (e = l("tagName"));
        var t = f({menclose: "enclose"}[e] || e);
        return [o(e, t[0]), O.elem(e, ["mstyle", "mpadded"]) ? t[1] : null]
    }

    function b(e) {
        var t = f(e);
        return O.iter(function (e) {
            e.disabled = !0
    ...
    function _() {
        return [e.menclose(f("\\ov")[0], {notation: "top"}, H), null]
    }

    function x() {
        var t = m("minsize"), r = f("minsize"), n = r[0];
        if ("mo" != e.mtagName(n)) throw"Can only stretch an operator symbol, before position " + e.re_.lastIndex;
        if (e.MathML) n.setAttribute("minsize", t); else {
            var i = /^(.+)em$/.exec(t);
            i && (t = i[1]);
            var s = Number(t);
    ...
    function A() {
        ...
        var r = f("\\binom")[0], n = f("\\binom")[0], a = o("mtable", O.map(t, [r, n]));
        return e.addClass(a, "ma-binom"), e.MathML || (a.fmUp -= .41, a.fmDn -= .41), [o("mrow", [o("mo", "("), a, o("mo", ")")]), null]
    }

    function N() {
        for (var t = e.re_.exec(Q); !t;) {
            if (e.re_.lastIndex = Q.length, W == V.length) return null;
            var r = V[W++];
            if ("string" == typeof r) e.re_.lastIndex = 0, Q = r, t = e.re_.exec(Q); else {
                if (1 == r.nodeType) return [r, null];
                O.err(err_scanTokP_)
            }
        }
        var n = t[2] || t[0], a = null;
        if (/^[_^}\u2196\u2199]$/.test(t[0]) || t[2] && e.macro1s_[n]) return [null, n];
        if ("{" == t[0]) return h();
        if (t[2] && e.macros_[n]) return e.macros_[n]();
        if (t[1]) return [e.newMe("mn", n, H), null];
        if (/^[,:;!]$/.test(t[2])) n = " "; else if ("/" == t[2]) n = "∕"; else if (e.alias_[n] && !t[2]) {
            var i = e.alias_[n];
            "string" == typeof i ? n = i : (n = i[0], a = i[1])
        }
        var s, u = e.infix_[n] || e.prefix_[n] || e.postfix_[n] ? n : null;
        if (" " == n) s = e.spaceMe(Z[t[2] || ","], H); else if (u) {
    ...
    function C(t) {
        var r = j(e.infix_[","]), n = r[1] || N(), a = r[0];
        if (!a) {
    ...
    function L(t) {
        for (var r = []; ;) {
            var n = C(0 == r.length), a = n[0], i = n[1] || N();
            if (a) {
    ...
    function S(t) {
        void 0 === t && (t = e.dtableQ);
        for (var r = []; ;) {
            var n = L(0 == r.length), a = n[0], i = n[1] || N();
            if (a && r.push(a), !i || ";" != i[1]) return [o("mtable", r, t ? {displaystyle: !0} : void 0), i]
        }
    }
    ...
    function P(t, r) {
        for (; ;) {
            ...
            if ("uo" == n || !r || (r[0] ? t : "ss" != F(r[1]))) {
                ...
                for (var l = [i]; r && !r[0] && "ss" == F(r[1]);) l.push(a());
                if (!t) if (r && r[0]) {
                    t = r, r = N();
                ...
                var o = [t[0]];
                O.iter(function (t) {
                    t ? o.push(t._ || e.newMe("none", void 0, H), t["^"] || e.newMe("none", void 0, H)) : o.push(e.newMe("mprescripts", void 0, H))
                }, l), t = [e.newMe("mmultiscripts", o, H), t[1]]
            }
        }
    }
    ...
    function j(t, r) {
        for (var n = null; ;) {
            if (!r && (r = N(), !r)) break;
            var a = r[1];
            if (!a || n && (r[0] ? !(e.infix_[a] || e.postfix_[a]) : e.macro1s_[a])) if (n) {
                if (t >= X) break;
                var i = j(X, r), s = i[0];
                s || O.err(err_parse_mxP_tokP_1_);
            ...
            } else n = r[0], r = null; else {
                var u = r[0];
                if (u) {
                    var l = e.infix_[a] || e.postfix_[a];
                    if (l && t >= l) break;
                    var m = e.infix_[a] || !(n && e.postfix_[a]) && e.prefix_[a];
                    !e.MathML && !n && m >= 290 && 350 >= m && (D(u).addClass("fm-large-op"), u.fmUp = .855, u.fmDn = .705);
                    var f = P(r), c = [];
                    f[0] || O.err(err_parse_mxP_tokP_embel_);
                    var p = f[0][0];
                    ...
                    if (1 == c.length) n = c[0]; else if ("/" == a && n && 3 == c.length || "√" == a && !n && 2 == c.length) "√" == a && "msup" == e.mtagName(c[0]) ? n = e.newMe("mroot", [c[1], e.mchilds(c[0])[1]], H) : (c.splice(c.length - 2, 1), n = e.newMe("/" == a ? "mfrac" : "msqrt", c, H)); else {
                        var o = e.newMe("mrow", c, H);
                        if (" " == a || (l || m) >= X) ; else {
                            var d = "";
                            "=" == a ? d = "infix-loose" : 2 == c.length ? (d = n ? "postfix" : "prefix", e.infix_[a] ? d += "-tight" : (/^[∀∃∄∂∇]$/.test(a) && (d = "quantifier"), e.addClass(o, "ma-repel-adj"))) : n && (d = "," == a || ";" == a ? "separator" : 270 >= l ? "infix-loose" : "infix", "|" == a && e.MathML && "mo" == u.tagName && (u.setAttribute("lspace", ".11em"), u.setAttribute("rspace", ".11em"))), e.MathML || !d || u.style.fontSize || D(p).addClass("fm-" + d)
                        }
                        n = o
                    }
                } else {
                    if ("}" == a) break;
                    if (e.macro1s_[a]) {
                        !n || O.err(err_parse_mxP_tokP_macro_);
                        var i = e.macro1s_[a]();
                        n = i[0], r = i[1]
                    } else {
                        if (J[a] || O.err(err_parse_mxP_tokP_script_), t >= 999) break;
                        var f = P(n && [n, null], r), h = f[0];
                        h || O.err(err_parse_mxP_tokP_embel_2_), r = f[1];
                        var c = [h[0]], g = h[1];
                        if (g) {
    ...
    Math.sign || (Math.sign = function (e) {
        ...
        return r && r.specified !== !1 ? r.value : void 0
    }, e.objToAttrs = function (e) {
        var t = [];
        for (var r in e) t.push({name: r, value: e[r]});
        return t
    }, e.setAttrs = function (t, r) {
        return r && null == r.length && (r = e.objToAttrs(r)), O.iter(function (e) {
        ...
        var r = D.fn.append;
        return r.apply(D("<tr/>"), O.map(t, arguments))
    }, e.mathmlNS = "http://www.w3.org/1998/Math/MathML";
    var E = !1;
    !function () {
        var t = navigator.userAgent.toLowerCase(), r = t.match(/webkit[ \/](\d+)\.(\d+)/);
        r ? (e.webkitVersion = [Number(r[1]), Number(r[2])], E = e.webkitVersion[0] <= 540) : (r = t.match(/(opera)(?:.*version)?[ \/]([\w.]+)/) || t.match(/(msie) ([\w.]+)/) || t.indexOf("compatible") < 0 && t.match(/(mozilla)(?:.*? rv:([\w.]+))?/), r && (e[r[1] + "Version"] = r[2] || "0"))
    }(), e.msieVersion && document.write('<object id=MathPlayer classid="clsid:32F66A20-7614-11D4-BD11-00104BD3F987">', '</object><?IMPORT namespace="m" implementation="#MathPlayer" ?>'), function () {
        if (self.location) {
            var t = location.search.match(/[?&;]mathml=(?:(off|false)|(on|true))\b/i);
            t ? e.MathML = !t[1] : (e.webkitVersion && O.cmpLex(O.cmpX, e.webkitVersion, [537, 17]) < 0 || e.operaVersion) && (e.MathML = !1)
        }
        ...
        if (e.msieVersion && !e.MathPlayer) try {
            if (new ActiveXObject("MathPlayer.Factory.1"), null == e.MathPlayer) e.MathPlayer = !0; else if (!e.MathPlayer) return !1
        } catch (r) {
            e.MathPlayer = !1
        }
        if (!e.MathPlayer && "undefined" == typeof document.createElementNS) return !1;
        var a = n("math", n("mn", "1")), i = n("math", n("mfrac", [n("mn", "1"), n("mn", "2")])),
            s = D(O.map(t, [a, i]));
        ...
        function t(e) {
            return "SPAN" == e.tagName || O.err(err_span0_), e.firstChild
        }

        "A" == e.tagName && 1 == e.childNodes.length && (e = e.firstChild);
        for (var r = e.getAttribute("mtagname"); "SPAN" == e.tagName;) e = e.firstChild;
        if ("TABLE" == e.tagName) {
            if (e = e.firstChild, "TBODY" == e.tagName || O.err(err_mchilds_tbody_), "mtable" == r) return e.childNodes;
            var n = e.childNodes;
            return "mover" == r ? n = [n[1], n[0]] : "munderover" == r && (n = [n[1], n[2], n[0]]), O.map(function (e) {
        ...
        if ("MROW" == e.tagName && r) {
            ...
            "mmultiscripts" == r || O.err(err_mchilds_mrow_);
            var a = Number(e.getAttribute("nprescripts"));
            a >= 0 && a < n.length && a % 2 == 0 || O.err(err_mchilds_mmultiscripts_);
        ...
        return O.elem(e.tagName, ["MSUB", "MSUP", "MSUBSUP"]) ? O.map(function (e, r) {
            return r ? t(e) : e
        }, e.childNodes) : "MSPACE" == e.tagName ? [] : e.childNodes
    };
    var $ = ["mn", "mi", "mo", "mtext", "mspace", "ms"],
        z = ["fmath", "msqrt", "mtd", "mstyle", "merror", "mpadded", "mphantom", "menclose"], R = {
            "¯": [0, .85],
            "‾": [0, .85],
            "˙": [0, .75],
            "ˇ": [0, .7],
    ...
    e.newMe = function (s, o, u, l) {
        if (l || (u && 9 == u.nodeType ? (l = u, u = void 0) : l = document), null != e.MathML || O.err(err_newMe_MathML_), e.MathML) return n(s, o, u, l);
        "math" == s && (s = "fmath");
        var m = D(t(l.createElement(s.toUpperCase()), o)), f = O.slice(m[0].childNodes);
        O.elem(s, z) && 1 != f.length && (f = [e.newMe("mrow", f, void 0, l)], 0 == m[0].childNodes.length || O.err(err_newMe_imp_mrow_), m.append(f[0]));
        var c = O.map(function (e) {
            return Number(e.fmUp || .6)
        }, f), p = O.map(function (e) {
            return Number(e.fmDn || .6)
        }, f);
        if ("fmath" == s || "mn" == s || "mtext" == s || "mprescripts" == s || "none" == s) ; else if ("mstyle" == s || "merror" == s || "mpadded" == s || "mphantom" == s || "menclose" == s) f[0].fmUp && (m[0].fmUp = f[0].fmUp), f[0].fmDn && (m[0].fmDn = f[0].fmDn); else if ("mi" == s) {
            ...
            var h = e.setAttrs(m[0], u);
            u = void 0, h.style.marginRight = h.getAttribute("width") || "0px", h.style.paddingRight = "0.001em", m.append("‌"), m.css("visibility", "hidden")
        } else if ("mrow" == s) {
            var g = O.applyF(Math.max, c), v = O.applyF(Math.max, p);
            (g > .65 || v > .65) && (m[0].fmUp = g, m[0].fmDn = v, O.iter(O([g, v, O._, void 0], a), f))
        } else if ("mfrac" == s) {
            if (2 != f.length) throw"Wrong number of <mfrac> arguments: " + f.length;
            var y = D('<td class="fm-num-frac fm-inline"></td>', l).append(f[0]),
                M = D('<td class="fm-den-frac fm-inline"></td>', l).append(f[1]);
            m = i(c[0] + p[0] + .03, c[1] + p[1] + .03, D('<span class="fm-vert fm-frac"></span>', l).append(D("<table/>", l).append(D("<tbody/>", l).append(D("<tr/>", l).append(y)).append(D("<tr/>", l).append(M))))).attr("mtagname", s)
        } else if ("msqrt" == s || "mroot" == s) {
            if (f.length != ("msqrt" == s ? 1 : 2)) throw"Wrong number of <" + s + "> arguments: " + f.length;
            m = D("<mrow/>", l).attr("mtagname", s);
            var b = .06 * (c[0] + p[0]), g = c[0] + b + .1, v = p[0];
            if ("mroot" == s) {
                var _ = .6 * (c[1] + p[1]), x = .25 / .6 - .25;
                g > _ ? x += g / .6 - c[1] : (x += p[1], g = _), m.append(D('<span class="fm-root fm-inline"></span>', l).append(f[1]).css("verticalAlign", x.toFixed(2) + "em"))
            }
            var w = D("<mo/>", l).addClass("fm-radic").append("√"),
                A = i(g, v, D('<span class="fm-vert fm-radicand"></span>', l).append(f[0]).css("borderTopWidth", b.toFixed(3) + "em"));
            ...
            for (var S = void 0, I = [], F = 0, T = 1; T < f.length; T++) {
                if ("mmultiscripts" == s) {
                    var L = e.mtagName(f[T]);
                    if ("mprescripts" == L) {
                        S = [], F = f.length - T - 1;
            ...
            var P, j = D("<tbody/>", l), g = .85 * c[0], v = .85 * p[0];
            if ("munder" != s) {
                var E = f[f.length - 1], $ = void 0;
                if (P = D("<td/>", l).append(E), "MO" == E.nodeName && 1 == E.childNodes.length) {
                    var d = E.firstChild;
                    3 == d.nodeType && ($ = R[d.data])
                }
                $ ? (E.style.display = "block", E.style.marginTop = (-$[0]).toFixed(2) + "em", E.style.marginBottom = (-$[1]).toFixed(2) + "em", g += 1.2 - O.sum($)) : (P.addClass("fm-script fm-inline"), g += .71 * (c[f.length - 1] + p[f.length - 1])), j.append(D("<tr/>", l).append(P))
            }
            if ("MI" == f[0].nodeName && 1 == f[0].childNodes.length) {
                var d = f[0].firstChild, U = d.data;
            ...
            P = D('<td class="fm-underover-base"></td>', l).append(f[0]), j.append(D("<tr/>", l).append(P)), "mover" != s && (P = D('<td class="fm-script fm-inline"></td>', l).append(f[1]), j.append(D("<tr/>", l).append(P)), v += .71 * (c[1] + p[1])), m = i(g, v, D('<span class="fm-vert"></span>', l).append(D("<table/>", l).append(j))).attr("mtagname", s)
        } else if ("mtable" == s) {
            var j = D("<tbody/>", l).append(D(f));
            m = D('<span class="fm-vert" mtagname="mtable"></span>', l).append(D("<table/>", l).append(j));
            var q = O.sum(c) + O.sum(p);
            m[0].fmUp = m[0].fmDn = .5 * q
        } else if ("mtr" == s) {
            m = D('<tr class="fm-mtr" mtagname="mtr"></tr>', l).append(D(f));
            var g = .6, v = .6;
            O.iter(function (t, r) {
            ...
            if ("mtd" != s) {
                if ("mfenced" == s) {
                    var h = e.setAttrs(m[0], u);
                    return e.newMe("mrow", e.mfencedToMRowArgs(h), u, l)
                }
                throw"Unrecognized or unimplemented MathML tagName: " + s
            }
            m = D('<td class="fm-mtd" mtagname="mtd"></td>', l).append(D(f)), c[0] > .65 && (m[0].fmUp = c[0]), p[0] > .65 && (m[0].fmDn = p[0]);
            var h = e.setAttrs(m[0], u);
            u = void 0;
            var B = h.getAttribute("rowspan"), Q = h.getAttribute("columnspan");
            B && (h.setAttribute("rowSpan", B), e.hasClass(h, "middle") || e.addClass(h, "middle")), Q && h.setAttribute("colSpan", Q)
        }
        return r(e.setAttrs(m[0], u))
    }, e.mfencedToMRowArgs = function (t) {
        function r(t) {
            return e.newMe("mo", t, void 0, n)
        }

        "mfenced" == t.tagName.toLowerCase() || O.err(err_mfencedToMRowArgs_);
        var n = t.ownerDocument,
            a = [r(O.defOr(e.getSpecAttrP(t, "open"), "(")), r(O.defOr(e.getSpecAttrP(t, "close"), ")"))],
            i = O.slice(t.childNodes);
        if (0 == i.length) return a;
        var s;
        if (1 == i.length) s = i[0]; else {
            for (var o = O.defOr(e.getSpecAttrP(t, "separators"), ",").match(/\S/g), u = o ? i.length - 1 : 0, l = 0; u > l; l++) i.splice(2 * l + 1, 0, r(o[Math.min(l, o.length - 1)]));
            s = e.newMe("mrow", i, void 0, n)
        }
        return a.splice(1, 0, s), a
    }, e.spaceMe = function (t, r) {
        return e.newMe("mspace", void 0, {width: t}, r)
    }, e.fenceMe = function (t, r, n, a) {
        return e.newMe("mrow", [e.newMe("mo", O.defOr(r, "("), a), t, e.newMe("mo", O.defOr(n, ")"), a)], a)
    }, O.iter(function (t) {
        e[t] = O(e.newMe, t)
        ...
        function n(e) {
            return 1 != e.nodeType ? e : (O.elem(e.tagName, $) || O.iter(n, e.childNodes), r(e))
        }

        function a(t) {
            function r(r) {
                return 3 == r.nodeType ? /^\s*$/.test(r.data) ? [] : [e.mtext(r.data, i)] : 8 == r.nodeType ? [] : (1 == t.nodeType || O.err(err_newMeDeep_), [a(r)])
            }

            var n = t.tagName.toLowerCase(), s = t.childNodes;
            O.elem(n, $) ? "mo" == n && 1 == s.length && 3 == s[0].nodeType && "-" == s[0].data && (s = e["-"]) : s = O.concatMap(r, s);
            var o = e.newMe(n, s, t.attributes, i);
            return "math" == n && e.setMathBlockQ(o, "block" == t.getAttribute("display")), o
        }

        if ((null == e.MathML || "math" != t.tagName.toLowerCase()) && O.err(err_eToMathE_), e.MathML && "math" == t.tagName) return E ? n(t) : t;
    ...
    e.decimalComma(RegExp("^(" + B + ")\\b", "i").test(document.documentElement.lang)), e.infix_ = {
        ...
        " ": 390,
        "": 500
    }, e.prefix_ = {}, e.postfix_ = {}, s(e.infix_, [[21, "|"], [30, ";"], [40, ",⁣"], [70, "∴∵"], [100, ":"], [110, "϶"], [150, "…⋮⋯⋱"], [160, "∋"], [170, "⊢⊣⊤⊨⊩⊬⊭⊮⊯"], [190, "∨"], [200, "∧"], [240, "∁∈∉∌⊂⊃⊄⊅⊆⊇⊈⊉⊊⊋"], [241, "≤"], [242, "≥"], [243, ">"], [244, "≯"], [245, "<"], [246, "≮"], [247, "≈"], [250, "∼≉"], [252, "≢"], [255, "≠"], [260, "=∝∤∥∦≁≃≄≅≆≇≍≔≗≙≚≜≟≡≨≩≪≫≭≰≱≺≻≼≽⊀⊁⊥⊴⊵⋉⋊⋋⋌⋔⋖⋗⋘⋙⋪⋫⋬⋭■□▪▫▭▮▯▰▱△▴▵▶▷▸▹▼▽▾▿◀◁◂◃◄◅◆◇◈◉◌◍◎●◖◗◦⧀⧁⧣⧤⧥⧦⧳⪇⪈⪯⪰"], [265, "⁄∆∊∍∎∕∗∘∙∟∣∶∷∸∹∺∻∽∾∿≂≊≋≌≎≏≐≑≒≓≕≖≘≝≞≣≦≧≬≲≳≴≵≶≷≸≹≾≿⊌⊍⊎⊏⊐⊑⊒⊓⊔⊚⊛⊜⊝⊦⊧⊪⊫⊰⊱⊲⊳⊶⊷⊹⊺⊻⊼⊽⊾⊿⋄⋆⋇⋈⋍⋎⋏⋐⋑⋒⋓⋕⋚⋛⋜⋝⋞⋟⋠⋡⋢⋣⋤⋥⋦⋧⋨⋩⋰⋲⋳⋴⋵⋶⋷⋸⋹⋺⋻⋼⋽⋾⋿▲❘⦁⦂⦠⦡⦢⦣⦤⦥⦦⦧⦨⦩⦪⦫⦬⦭⦮⦯⦰⦱⦲⦳⦴⦵⦶⦷⦸⦹⦺⦻⦼⦽⦾⦿⧂⧃⧄⧅⧆⧇⧈⧉⧊⧋⧌⧍⧎⧏⧐⧑⧒⧓⧔⧕⧖⧗⧘⧙⧛⧜⧝⧞⧠⧡⧢⧧⧨⧩⧪⧫⧬⧭⧮⧰⧱⧲⧵⧶⧷⧸⧹⧺⧻⧾⧿⨝⨞⨟⨠⨡⨢⨣⨤⨥⨦⨧⨨⨩⨪⨫⨬⨭⨮⨰⨱⨲⨳⨴⨵⨶⨷⨸⨹⨺⨻⨼⨽⨾⩀⩁⩂⩃⩄⩅⩆⩇⩈⩉⩊⩋⩌⩍⩎⩏⩐⩑⩒⩓⩔⩕⩖⩗⩘⩙⩚⩛⩜⩝⩞⩟⩠⩡⩢⩣⩤⩥⩦⩧⩨⩩⩪⩫⩬⩭⩮⩯⩰⩱⩲⩳⩴⩵⩶⩷⩸⩹⩺⩻⩼⩽⩾⩿⪀⪁⪂⪃⪄⪅⪆⪉⪊⪋⪌⪍⪎⪏⪐⪑⪒⪓⪔⪕⪖⪗⪘⪙⪚⪛⪜⪝⪞⪟⪠⪡⪢⪣⪤⪥⪦⪧⪨⪩⪪⪫⪬⪭⪮⪱⪲⪳⪴⪵⪶⪷⪸⪹⪺⪻⪼⪽⪾⪿⫀⫁⫂⫃⫄⫅⫆⫇⫈⫉⫊⫋⫌⫍⫎⫏⫐⫑⫒⫓⫔⫕⫖⫗⫘⫙⫚⫛⫝⫝⫞⫟⫠⫡⫢⫣⫤⫥⫦⫧⫨⫩⫪⫫⫬⫭⫮⫯⫰⫱⫲⫳⫴⫵⫶⫷⫸⫹⫺⫻⫽⫾"], [270, "←↑→↓↔↕↖↗↘↙↚↛↜↝↞↟↠↡↢↣↤↥↦↧↨↩↪↫↬↭↮↯↰↱↲↳↴↵↶↷↸↹↺↻↼↽↾↿⇀⇁⇂⇃⇄⇅⇆⇇⇈⇉⇊⇋⇌⇍⇎⇏⇐⇑⇒⇓⇔⇕⇖⇗⇘⇙⇚⇛⇜⇝⇞⇟⇠⇡⇢⇣⇤⇥⇦⇧⇨⇩⇪⇫⇬⇭⇮⇯⇰⇱⇲⇳⇴⇵⇶⇷⇸⇹⇺⇻⇼⇽⇾⇿⊸⟰⟱⟵⟶⟷⟸⟹⟺⟻⟼⟽⟾⟿⤀⤁⤂⤃⤄⤅⤆⤇⤈⤉⤊⤋⤌⤍⤎⤏⤐⤑⤒⤓⤔⤕⤖⤗⤘⤙⤚⤛⤜⤝⤞⤟⤠⤡⤢⤣⤤⤥⤦⤧⤨⤩⤪⤫⤬⤭⤮⤯⤰⤱⤲⤳⤴⤵⤶⤷⤸⤹⤺⤻⤼⤽⤾⤿⥀⥁⥂⥃⥄⥅⥆⥇⥈⥉⥊⥋⥌⥍⥎⥏⥐⥑⥒⥓⥔⥕⥖⥗⥘⥙⥚⥛⥜⥝⥞⥟⥠⥡⥢⥣⥤⥥⥦⥧⥨⥩⥪⥫⥬⥭⥮⥯⥰⥱⥲⥳⥴⥵⥶⥷⥸⥹⥺⥻⥼⥽⥾⥿⦙⦚⦛⦜⦝⦞⦟⧟⧯⧴⭅⭆"], [275, "+-±−∓∔⊞⊟"], [300, "⊕⊖⊘"], [340, "≀"], [350, "∩∪"], [390, "*.×•⁢⊠⊡⋅⨯⨿"], [400, "·"], [410, "⊗"], [640, "%"], [650, "\\∖"], [660, "/÷"], [710, "⊙"], [825, "@"], [835, "?"], [850, "⁡"], [880, "^_⁤"]]), s(e.prefix_, [[10, "‘“"], [20, "([{‖⌈⌊❲⟦⟨⟪⟬⟮⦀⦃⦅⦇⦉⦋⦍⦏⦑⦓⦕⦗⧼"], [230, "∀∃∄"], [290, "∑⨊⨋"], [300, "∬∭⨁"], [310, "∫∮∯∰∱∲∳⨌⨍⨎⨏⨐⨑⨒⨓⨔⨕⨖⨗⨘⨙⨚⨛⨜"], [320, "⋃⨃⨄"], [330, "⋀⋁⋂⨀⨂⨅⨆⨇⨈⨉⫼⫿"], [350, "∏∐"], [670, "∠∡∢"], [680, "¬"], [740, "∂∇"], [845, "ⅅⅆ√∛∜"]]), s(e.postfix_, [[10, "’”"], [20, ")]}‖⌉⌋❳⟧⟩⟫⟭⟯⦀⦄⦆⦈⦊⦌⦎⦐⦒⦔⦖⦘⧽"], [800, "′♭♮♯"], [810, "!"], [880, "&'`~¨¯°´¸ˆˇˉˊˋˍ˘˙˚˜˝˷̂̑‾⃛⃜⎴⎵⏜⏝⏞⏟⏠⏡"]]);
    var Q, V, W, H, X;
    e.macros_ = {
        mn: O(c, "mn"),
        mi: O(c, "mi"),
        ...
        bs: O(y, "bold-script"),
        fr: O(y, "fraktur"),
        ds: O(y, "double-struck"),
        bf: O(y, "bold-fraktur"),
        mstyle: O(M, "mstyle"),
        merror: O(M, "merror"),
        mpadded: O(M, "mpadded"),
        phantom: O(b, "phantom"),
        vphantom: O(b, "vphantom"),
        enclose: O(M, "menclose"),
        ov: _,
        minsize: x,
        mrowOne: w,
        binom: A
    ...
    var J = {_: "sub", "^": "sup", "↙": "under", "↖": "over"};
    return e.sMxAToMe = function (t, r) {
        r || (r = document), e.infix_[""] && e.infix_[","] || O.err(err_sToMe_1_), void 0 === e.MathML && (e.MathML = e.canMathML()), e.re_.lastIndex = 0, Q = "", V = Array.isArray(t) ? t : [t], W = 0, H = r, X = e.infix_[""];
        var n = j(0);
        if (n[1]) throw"Extra input:  " + n[1][1] + Q.substring(e.re_.lastIndex) + (W < V.length ? "..." : "");
        return (e.re_.lastIndex < Q.length || W < V.length) && O.err(err_sToMe_2_), n[0] || u()
    }, e.sToMathE = function (t, r, n) {
        var a = e.sMxAToMe(t, n);
        return O.elem(e.mtagName(a), ["math", "fmath"]) || (a = e.newMe("math", a, n)), "string" == typeof t && a.setAttribute("alttext", t), e.setMathBlockQ(a, r)
    }, e.$mathQ = !0, e.inline$$Q = !1, e.parseMath = function (t) {
        if (1 == t.nodeType && "SCRIPT" != t.tagName) if ("MATH" == t.tagName.toUpperCase()) {
            var r = e.eToMathE(t);
            r != t && t.parentNode.replaceChild(r, t)
        } else for (var n = t.firstChild; n;) {
            var a = n.nextSibling;
            e.parseMath(n), n = a
        } else if (3 == t.nodeType && /[$\\]/.test(t.data)) {
            for (var i = t.ownerDocument, s = t.data, o = [], u = "", l = /\\([$\\])|\$\$?|\\[([]/g; ;) {
                var m = l.lastIndex, f = l.exec(s), c = f ? f.index : s.length;
                if (c > m && (u += s.substring(m, c)), f && f[1]) u += f[1]; else {
                    var p, d = -1;
                    if (f) {
                        if (p = "\\(" == f[0] ? "\\)" : "\\[" == f[0] ? "\\]" : f[0], l.lastIndex < s.length && ("$" != f[0] || e.$mathQ)) for (d = s.indexOf(p, l.lastIndex); -1 != d && "\\" == s.charAt(d - 1);) d = s.indexOf(p, d + 1);
                        if (-1 == d) {
                            u += f[0];
                            continue
                        }
                    }
                    if (u && (o.push(i.createTextNode(u)), u = ""), !f) break;
                    var h = "$$" == f[0] || "\\[" == f[0], g = e.sToMathE(s.substring(l.lastIndex, d), h, i);
                    if (h && e.inline$$Q && O.elem(t.parentNode.nodeName, ["P", "SPAN"])) {
                        var v = D("<div/>", i).css("display", "inline-block").append(g);
                        v = D("<span/>", i).css("white-space", "nowrap").append(v), g = v[0]
                    }
                    o.push(g), l.lastIndex = d + p.length
                }
            }
            O.iter(function (e) {
        ...
        if (void 0 === e.MathML && (e.MathML = e.canMathML()), e.parseMathQ) try {
            e.parseMath(document.body)
        } catch (t) {
            alert(t)
        }
    }), null == D.fn.parseMath && (D.fn.parseMath = function () {
        return O.iter(e.parseMath, this), this
    }), e
}(), M;
void 0 === M && (M = jqMath);